...
abstract class BaseAdapter<T> : RecyclerView.Adapter<BaseViewHolder<T>>() {
     ...
     * fields
     * */
    protected var mItemDownloadClickListener: ItemClickListener<T>? = null
    protected var mItemPlayVideoClickListener: ItemPlayVideoClickListener<T>? = null
    protected var mItemViewPdfClickListener: ItemClickListener<T>? = null
    ...
    private var isFixedItems=false
    ...
    fun dataChanges(): Flowable<Int> {
        return mRxAdapterSize
                ...
                ?: Flowable.error(Throwable("adapter size is null"))
    }
     ...
     */
    fun setItemDownloadClickListener(listener: ItemClickListener<T>) {
        this.mItemDownloadClickListener = listener
    }
    fun setItemPlayVideoClickListener(listener: ItemPlayVideoClickListener<T>) {
        this.mItemPlayVideoClickListener = listener
    }
    fun setItemViewPdfClickListener(listener: ItemClickListener<T>) {
        this.mItemViewPdfClickListener = listener
    }
    ...
    fun setIsFixedItems(boolean: Boolean){
